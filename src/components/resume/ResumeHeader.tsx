...
const ResumeHeader = () => {
  return <header className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="absolute top-32 right-20 w-48 h-48 bg-accent/15 rounded-full blur-3xl animate-float" style={{
      animationDelay: '1s'
    }}></div>
      <div className="absolute bottom-32 left-32 w-64 h-64 bg-secondary/10 rounded-full blur-3xl animate-float" style={{
      animationDelay: '2s'
    }}></div>
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        <div className="mb-8">
          ...
          <div className="text-2xl md:text-3xl text-accent font-medium mb-6 animate-fade-in" style={{
          animationDelay: '0.2s'
        }}>
            花名：云澹
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12 animate-fade-in" style={{
        animationDelay: '0.6s'
      }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center animate-fade-in" style={{
        animationDelay: '0.8s'
      }}>

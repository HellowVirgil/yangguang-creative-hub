...
const ResumeHeader = () => {
  return (
    <header className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        className="absolute top-32 right-20 w-48 h-48 bg-accent/15 rounded-full blur-3xl animate-float"
        style={{
          animationDelay: "1s",
        }}
      ></div>
      <div
        className="absolute bottom-32 left-32 w-64 h-64 bg-secondary/10 rounded-full blur-3xl animate-float"
        style={{
          animationDelay: "2s",
        }}
      ></div>
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <div className="p-6 rounded-lg bg-card/50 backdrop-blur-sm border border-border/50 card-glow">
            ...
            <div className="text-muted-foreground">用户体验</div>
          </div>
        </div>
      </div>

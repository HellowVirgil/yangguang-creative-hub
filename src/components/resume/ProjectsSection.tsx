  ...
  const projects = [
    {
      ...
      description:
        "一款移动端富文本编辑器，基于 Hybrid 技术实现 Android 和 iOS 的富文本编辑器。",
      highlights: [
    ...
    },
    {
      ...
      description:
        "新高考需求下为教师提供排课功能的智能排课平台，支持复杂排课算法和多场景部署。",
      highlights: [
    ...
    },
    {
      ...
      description:
        "基于 Schema 驱动的可视化专题页面配置平台，支持拖拽式页面搭建和组件化开发。",
      highlights: [
    ...
    },
    {
      ...
      icon: <Code2 className="w-6 h-6" />,
      description:
        "模块化的 Hybrid 容器通信 Bridge 框架，解决 H5 与原生 App 的高效通信问题。",
      highlights: [
        "模块化架构设计，支持按需加载和插件扩展",
    ...
    },
    {
      ...
      icon: <Layers className="w-6 h-6" />,
      description:
        "一套代码适配多平台的导流与行为适配库，解决多端开发和动态导流的复杂性问题。",
      highlights: [
    ...
    },
    {
      ...
      icon: <Layers className="w-6 h-6" />,
      description:
        "支持数百万基层学习组织的党员管理平台，承载大规模用户的学习管理和数据分析需求。",
      highlights: [
    ...
    },
    {
      ...
      icon: <Code2 className="w-6 h-6" />,
      description:
        "支撑学习强国线上答题的核心应用，服务千万级用户的在线学习和考试需求。",
      highlights: [
        "高并发架构设计，支持千万用户同时在线",
        "实时答题系统，毫秒级响应速度",
        "智能防作弊机制，保证考试公平性",
    ...
    },
    {
      ...
      icon: <Palette className="w-6 h-6" />,
      description:
        "遵循融媒体 UI 规范的企业级 Vue 组件库，支持答题、学习管理等多个业务线。",
      highlights: [
        "基于 Vue.js 的企业级组件库架构",
    ...
    },
    {
      ...
      icon: <Palette className="w-6 h-6" />,
      description:
        "基于 Vision 引擎的可视化搭建系统，支持答题、问卷等业务的快速搭建能力。",
      highlights: [
        "基于 Vision 引擎的渲染架构",
        "拖拽式组件编排和属性配置",
        "数据源管理和 API 集成",
      ...
      techStack: ["React", "TypeScript", "Vision Engine"],
      tags: ["可视化搭建", "多端发布", "数据驱动"],
    },
    {
      title: "nut 前端脚手架",
      period: "融媒体时期",
      icon: <Code2 className="w-6 h-6" />,
      description:
        "部门统一的前端脚手架工具，支持多技术栈、多业务场景的项目快速创建和标准化开发。",
      highlights: [
                ...
                <div className="flex flex-wrap gap-1">
                  {project.techStack.map((tech) => (
                    <Badge
                      key={tech}
                      variant="outline"
                      className="text-xs bg-secondary/10 border-secondary/30 hover:bg-secondary/20"
                    >
                      {tech}
                    </Badge>
                  ))}

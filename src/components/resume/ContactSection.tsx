        ...
        <CardContent className="p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-foreground mb-6">我的优势</h3>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">yangguang@example.com</div>
                  </div>
                </Button>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">扫码或搜索添加</div>
                  </div>
                </Button>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">查看我的开源项目</div>
                  </div>
                </Button>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">职业社交网络</div>
                  </div>
                </Button>
              </div>
            </div>
          ...
          <div className="mt-12 text-center">
            <Button size="lg" className="bg-gradient-primary hover:opacity-90 text-white font-medium px-8 py-4 text-lg">
